...
-- which is a modification of lunatico_rings.lua
...
},
{
    ...
    graph_start_angle=180,
    graph_unit_angle=2.7,          graph_unit_thickness=2.7,
    graph_bg_colour=0x77B753,      graph_bg_alpha=0.3,
    graph_fg_colour=0xEF5A29,      graph_fg_alpha=0.5,
    hand_fg_colour=0xEF5A29,       hand_fg_alpha=1.0,
    txt_radius=42,
    txt_weight=0,                  txt_size=9.0,
    ...
    graduation_unit_angle=27,
    graduation_fg_colour=0xEF5A29, graduation_fg_alpha=0.5,
    caption='',
    caption_weight=1,              caption_size=10.0,
    caption_fg_colour=0xEF5A29,    caption_fg_alpha=0.3,
},
}
